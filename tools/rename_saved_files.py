...
def main(
    file_1 = "/home/till/mmclassification/work_dirs/resnet18_selftrained/epoch_195.pth",
    file_2 = "/home/till/mmclassification/pretrained_models/resnet50_imagenette.pth",
    renames_1 = ["little", "little_head"],
    renames_2 = ["big", "big_head"],
    save_new = "/home/till/mmclassification/pretrained_models/cascading_imagenette.pth"
):
