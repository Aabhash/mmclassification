...
class EarlyExitClassifier(BaseClassifier):
    ...
    def __init__(self,
                 ...
                 train_cfg=None,
                 init_cfg=None):
        super(EarlyExitClassifier, self).__init__(init_cfg)
    ...
    def extract_feat(self, img, return_loss, stage='neck'):
        ...
        x = self.backbone(img, return_loss)
    ...
    def forward_train(self, img, gt_label, **kwargs):
        ...
        x = self.extract_feat(img, return_loss=True)
    ...
    def simple_test(self, img, img_metas=None, **kwargs):
        ...
        x = self.extract_feat(img, return_loss=False)
