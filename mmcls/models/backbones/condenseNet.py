...
class _DenseLayer(nn.Module):
    def __init__(self, in_channels, growth_rate, args):
        ...
        self.group_1x1 =   4                        # for fast args.group_1x1
        self.group_3x3 = 4                           # for fast args.group_3x3
        self.bottleneck = 4                        # normaly in arges 
        self.condense_factor = 4                   # normaly in args
        self.dropout_rate = 0
        ### 1x1 conv i --> b*k
        self.conv_1 = LearnedGroupConv(in_channels, self.bottleneck * growth_rate,
...
class CondenseNet(BaseBackbone):
    def __init__(self,
                stages,
                growth,
     ...
     args):
        ...
        self.stages = list(map(int, stages.split('-')))
        self.growth = list(map(int, growth.split('-')))
    ...
    def forward(self, x, progress=None):
        ...
        #out = self.classifier(out) #this is head
        return out