...
time="$(time( python3 tools/test.py $CONFIG_FOLDER/001_BranchyNet-Imagenette2.py \
...
time="$(time( python3 tools/test.py $CONFIG_FOLDER/010_BranchyNet-Imagenette2.py \
        $CPT_FILE --metrics=accuracy \
...
time="$(time( python3 tools/test.py $CONFIG_FOLDER/011_BranchyNet-Imagenette2.py \
        $CPT_FILE --metrics=accuracy \
...
time="$(time( python3 tools/test.py $CONFIG_FOLDER/100_BranchyNet-Imagenette2.py \
        $CPT_FILE --metrics=accuracy \
...
time="$(time( python3 tools/test.py $CONFIG_FOLDER/101_BranchyNet-Imagenette2.py \
        $CPT_FILE --metrics=accuracy \
...
time="$(time( python3 tools/test.py $CONFIG_FOLDER/110_BranchyNet-Imagenette2.py \
        $CPT_FILE --metrics=accuracy \
...
time="$(time( python3 tools/test.py $CONFIG_FOLDER/111_BranchyNet-Imagenette2.py \
        $CPT_FILE --metrics=accuracy \
        --out=$OUT_DIR/val_branchynet110.json >> $LOG_FILE) 2>&1 1>/dev/null )"
echo "Wallclock Time elapsed:" | echo $time 
"Wallclock Time elapsed:" >> $LOG_FILE | $time >> $LOG_FILE
